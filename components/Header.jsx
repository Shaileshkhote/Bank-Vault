...
import Home from '../pages/Deposit';
  ...
  return (
    <div>
      <div className='fixed top-0 left-0 z-20 w-full shadow-md'>
        <div className='items-center justify-between py-4 bg-gray-900 md:flex md:px-10 px-7'>
      ...
      text-gray-800'>
          ...
          <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-gray-900 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 ' : 'top-[-490px]'}`}>
            {
              Links.map((link) => (
                <li key={link.name} className='text-sm md:ml-8 md:my-0 my-7'>
                  <Link href={link.link} className='text-gray-100 duration-500 hover:text-gray-400'><p className='text-gray-100 duration-500 hover:text-gray-400'>{link.name}</p></Link>
                </li>
              ))
            }
            ...
            <div classNameName="">
              <button
                ...
                type="button"
                className="h-10 px-2 py-2 ml-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg md:ml-12 lg:ml-12 2xl:ml-12 bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 items-cente dark:text-white "
              >
              ...
              {account ? (
                <button
                  ...
                  type="button"
                  className="h-10 px-2 py-2 ml-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 items-cente dark:text-white "
                >
              ...
              {/* <button
              type="button"
              className="inline-flex items-center invisible h-10 px-2 py-2 ml-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg md:visible lg:visible 2xl:visible bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:focus:ring-gray-600 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 "
            >
              <svg
                version="1.0"
